...
Interesting: the first one has its predicted score more affected if we simulate it 
as a 2020s song, while Karma Chameleon seems to be a tune that still adapts to today's 
listeners.
